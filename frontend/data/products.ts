...
const seeds: ProductSeed[] = [
  ...
  },
  {
    ...
    stock: 176,
    badges: ["27% OFF"],
    images: flavorSet("tomato-chilli"),
    description:
  ...
  },
  {
    ...
    title: "Combo of 3: Salt & Pepper + Pudina + Tomato & Chilli",
    subtitle: "The Everyday Crunch Trio - classic, refreshing, and spicy in one box.",
    price:  657,
    compareAtPrice:  897,
    rating: 4.8,
    reviewCount: 76,
    tags: ["combo-pack", "bundle-3", "salt-pepper", "pudina", "tomato-chilli"],
    collectionHandles: ["combos"],
    stock: 96,
    badges: ["Bestseller"],
    images: [
      "/combo-banners/Combo%203/pudina-salt-tomato.png",
      "/combo-banners/Combo%203/pudina-salt-tomato.png",
      "/combo-banners/Combo%203/pudina-salt-tomato.png"
    ],
    description:
      "Combo Name: The Everyday Crunch Trio. Hero Hook: Three moods, one jar at a time. This combo covers daily snacking cravings without getting boring. What's inside: Salt & Pepper (clean classic crunch), Pudina (fresh minty lift), Tomato & Chilli (tangy spice punch). Flavour experience: start light with salt-pepper, refresh with pudina, then finish with tomato chilli heat. Why this combo works: balanced flavour mix, light + spicy + refreshing, ideal first-time trial pack. Perfect for office desk snacks, family sharing, tea-time platters, and first-time Nutrisuddh buyers. Clean snacking note: all variants are slow-roasted, never fried."
  },
  {
    id: "p7",
    ...
    badges: ["New"],
    images: [
      "/combo-banners/Combo%203/tomato-pudina-cream.png",
      "/combo-banners/Combo%203/tomato-pudina-cream.png",
      "/combo-banners/Combo%203/tomato-pudina-cream.png"
    ],
    description:
  ...
  },
  {
    ...
    title: "Combo of 3: Cream & Onion + Peri Peri + Cheese",
    subtitle: "The Cheesy Heat Fusion Box - comfort flavours with a bold spicy edge.",
    price:  657,
    compareAtPrice:  897,
    rating: 4.9,
    reviewCount: 59,
    tags: ["combo-pack", "bundle-3", "cream-onion", "peri-peri", "cheese"],
    collectionHandles: ["combos"],
    stock: 90,
    badges: ["Bestseller"],
    images: [
      "/combo-banners/Combo%203/pudina-cheese-periperi.png",
      "/combo-banners/Combo%203/pudina-cheese-periperi.png",
      "/combo-banners/Combo%203/pudina-cheese-periperi.png"
    ],
    description:
      "Combo Name: The Cheesy Heat Fusion Box. Hero Hook: where comfort meets fire. This is a bold flavour lover's combo with creamy, cheesy indulgence and smoky peri peri heat. What's inside: Cream & Onion (smooth savoury creaminess), Peri Peri (smoky global spice), Cheese (rich indulgent crunch). Flavour experience: silky cream onion start, sharp cheesy bite, then a peri peri heat finish. Why this combo works: cheese-lover favourite, international plus comfort profile, perfect binge snacking box. Perfect for movie marathons, late-night cravings, cheese snack fans, and gifting boxes. Clean snacking note: all variants are roasted, not fried."
  },
  {
    id: "p9",
    ...
    badges: ["New"],
    images: [
      "/combo-banners/Combo%203/pudina-cream-periperi.png",
      "/combo-banners/Combo%203/pudina-cream-periperi.png",
      "/combo-banners/Combo%203/pudina-cream-periperi.png"
    ],
    description:
  ...
  },
  {
    ...
    images: [
      "/combo-banners/Combo%206/pack-6.png",
      "/combo-banners/Combo%206/pack-6.png",
      "/combo-banners/Combo%206/pack-6.png"
    ],
    description:
